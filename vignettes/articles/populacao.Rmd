...
Assim, se queremos um banco com as estimativas para vários anos, há que se levar em conta se o período desejado inclui arquivos com diferente estrutura e em tal caso fazer previamente as adequações necessárias, isto é, retirar a variável `situacao` das estimativas até 2012 
...
ler_popbr(2013)
Rcoisas::ggplot_pir(cl2, "fxetar5", "sexo", "populacao", nsize = 2.5) +
