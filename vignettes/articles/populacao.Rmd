...
Assim, se queremos um banco com as estimativas para vários anos, há que se levar em conta se o período desejado inclui arquivos com diferente estrutura e em tal caso retirar a variável `situacao` e a categoria `I000` das estimativas até 2012 e a variável `fxetaria` de todos os bancos.
...
```{r fig.alt="Pirâmide populacional", results='hide', out.width="48%", fig.show='hold', fig.align='center'}
