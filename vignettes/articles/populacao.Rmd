...
Assim, se queremos um banco com as estimativas para vários anos, há que se levar em conta se o período desejado inclui arquivos com diferente estrutura e em tal caso retirar a variável `situacao` das estimativas até 2012 e retirar a variável `fxetaria` de todos os bancos.
Assim, se queremos um banco com as estimativas para vários anos, há que se levar em conta se o período desejado inclui arquivos com diferente estrutura e em tal caso retirar a variável `situacao` e a categoria `IOO` das estimativas até 2012 e a variável `fxetaria` de todos os bancos.
...
Rcoisas::plot_pir(br1980)
Rcoisas::plot_pir(br2024)
```

```{r fig.alt="Pirâmide populacional"}
Rcoisas::ggplot_pir(br, "fxetar5", "sexo", "populacao", nsize = 2.5) +
