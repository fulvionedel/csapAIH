...
O código abaixo cria um `data.frame` com as informações das AIHs do "ano de competência" 2021 no RS e outro com as informações das Declarações de Óbito (DO) de residentes do RS ocorridas em 2021.
