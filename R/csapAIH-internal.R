...
#'    Com o retorno à disponibilização dos arquivos de estimativa populacional pelo DATASUS, a função \code{\link{ler_popbr}} agora lê os arquivos de 1980 a 2024. Criada ainda a função \code{\link{popbr}} para facilitar a leitura e unificação de arquivos até 2012 e daquele ano em diante, que têm diferente estrutura.
